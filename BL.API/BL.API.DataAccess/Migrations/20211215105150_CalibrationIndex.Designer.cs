...
namespace BL.API.DataAccess.Migrations
{
    ...
    [Migration("20211215105150_CalibrationIndex")]
    partial class CalibrationIndex
    {
            ...
            modelBuilder.Entity("BL.API.Core.Domain.Match.Match", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 15, 10, 51, 50, 613, DateTimeKind.Utc).AddTicks(7142));
            ...
            modelBuilder.Entity("BL.API.Core.Domain.Match.PlayerMatchRecord", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 15, 10, 51, 50, 619, DateTimeKind.Utc).AddTicks(6122));
            ...
            modelBuilder.Entity("BL.API.Core.Domain.Player.Player", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 15, 10, 51, 50, 619, DateTimeKind.Utc).AddTicks(5145));
