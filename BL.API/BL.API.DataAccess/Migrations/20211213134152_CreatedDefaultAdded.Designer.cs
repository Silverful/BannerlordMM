...
namespace BL.API.DataAccess.Migrations
{
    ...
    [Migration("20211213134152_CreatedDefaultAdded")]
    partial class CreatedDefaultAdded
    {
            ...
            modelBuilder.Entity("BL.API.Core.Domain.Match.Match", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 13, 13, 41, 52, 379, DateTimeKind.Utc).AddTicks(9793));
            ...
            modelBuilder.Entity("BL.API.Core.Domain.Match.PlayerMatchRecord", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 13, 13, 41, 52, 386, DateTimeKind.Utc).AddTicks(9156));
            ...
            modelBuilder.Entity("BL.API.Core.Domain.Player.Player", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 13, 13, 41, 52, 386, DateTimeKind.Utc).AddTicks(7577));
